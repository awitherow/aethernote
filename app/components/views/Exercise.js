...
const checkRecord = (a, b) => ({
    multiplier: parseInt(a.value) > parseInt(b.value)
        ? a.multiplier
        : b.multiplier,
...
export default class Exercise extends Component {
        ...
        this.props.submitEdit(
            {
                ...
                value: {
                    ...
                    total: this.state[entry.id].value *
                        this.state[entry.id].multiplier,
                },
                content: {
                    best: checkRecord(this.state[entry.id], content.best),
                    total: content.total +
                        this.state[entry.id].value *
                            this.state[entry.id].multiplier,
                },
            },
            entry,
    ...
    render() {
        ...
        const filteredEntries = filter
            ? sortedEntries.filter(entry => entry.category === category)
            : sortedEntries;
        ...
        `}</style>
                <div className="note-list-modifer">
                    <DropdownButton
                        id={`${type}-selector`}
                        title={
                            this.state.category ? this.state.category : 'Form'
                        }
                    >
