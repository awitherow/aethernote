...
export default class Habit extends Component {
    ...
    recordHabit = entry => {
        this.props.submitEdit(
            {
                content: parseInt(entry.content) +
                    parseInt(this.state[entry.id]),
                tally: true,
        ...
        `}</style>
                <div className="note-list-modifer">
                    <DropdownButton
                        id={`${type}-selector`}
                        title={
                            this.state.category ? this.state.category : 'Impact'
                        }
                    >
                            ...
                            <tr key={i}>
                                ...
                                <td className="input-with-button">
                                    ...
                                    <Button
                                        block={isMobile}
                                        bsSize="xsmall"
                                        onClick={() => this.recordHabit(entry)}
                                    >
